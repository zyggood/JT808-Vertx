...
public class ValidationChain {
    ...
    public static class ValidationChainResult {
        ...
        public List<MessageValidator.ValidationResult> getValidatorResults() {
            return validatorResults;
        }

        public List<MessageValidator.ValidationError> getAllErrors() {
            return allErrors;
        }

        public List<MessageValidator.ValidationWarning> getAllWarnings() {
            return allWarnings;
        }
    ...
    public static class ValidationConfig {
        ...
        public boolean isStopOnFirstStrictFailure() {
            return stopOnFirstStrictFailure;
        }
