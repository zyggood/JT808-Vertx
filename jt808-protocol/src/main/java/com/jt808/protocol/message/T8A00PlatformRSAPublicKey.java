 ...
 * 消息ID: 0x8A00
 * 
 * 该消息用于平台向终端下发RSA公钥，包含RSA公钥的e和n参数。
 * RSA公钥格式为{e,n}，其中：
 * - e: 公钥指数，4字节DWORD
 * - n: 公钥模数，128字节数组
 * 
 ...
 * @since 1.0.0
 */
public class T8A00PlatformRSAPublicKey extends JT808Message {
     ...
     * 默认构造函数
     */
    public T8A00PlatformRSAPublicKey() {
        super();
     ...
     */
    public T8A00PlatformRSAPublicKey(long publicExponent, byte[] modulus) {
        super();
     ...
     */
    public T8A00PlatformRSAPublicKey(BigInteger publicExponent, BigInteger modulus) {
        super();
    ...
    public int getMessageId() {
        return MessageTypes.Platform.PLATFORM_RSA_PUBLIC_KEY;
    }
    ...
    public boolean equals(Object o) {
        ...
        T8A00PlatformRSAPublicKey that = (T8A00PlatformRSAPublicKey) o;
    ...
    public String toString() {
        return "T8A00PlatformRSAPublicKey{" +
